...
Até agora trabalhamos com tipos primitivos: `int`, `float`, `char`. Mas dados reais são mais complexos. Uma pessoa tem nome, idade e endereço. Um ponto tem coordenadas x e y. Um pacote de rede tem cabeçalho, payload e checksum.
...
Isso define um **tipo** chamado `struct Ponto`. Ainda não criamos nenhuma variável — apenas declaramos como ela será estruturada.

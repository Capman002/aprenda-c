...
order: 6
slug: "git-versionamento/ferramentas-pratica"
...
Chega de teoria. Vamos colocar os projetos de C que criamos durante o curso no GitHub.
...
Crie um arquivo `.gitignore` na raiz. **Isso é crucial**. Não queremos subir binários compilados (`.exe`, `.o`, `.bin`) nem pastas de IDE.

...
order: 2
slug: "linguagens-modernas/rust-ownership"
...
Em C++, `s2 = s1` faria uma cópia rasa (shallow copy), e ambos apontariam para a mesma memória. Se ambos derem `free`, tenho double-free.

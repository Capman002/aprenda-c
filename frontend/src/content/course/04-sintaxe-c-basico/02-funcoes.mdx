...
<Callout type="tip" title="Boa Prática">
  Em projetos reais, protótipos ficam em arquivos `.h` (headers),
  e as implementações em arquivos `.c`. Isso será abordado em módulos posteriores.
</Callout>
...
<Callout type="warning" title="Evite Globais">
  Variáveis globais são tentadoras, mas tornam o código difícil de entender e depurar.
...
Você agora sabe estruturar código em funções. No próximo módulo, vamos mergulhar em **ponteiros e memória** — o recurso mais poderoso (e perigoso) do C.
